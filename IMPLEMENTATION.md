...
**Colleen Piccolo:**
Added basic structure to the FavoriteRoutesPage class. Since I don't know how to use React, I implemented and derived most of the structure from the following React tutorial page: https://react.dev/learn. The full citation is in the source code file FavoriteRoutesPage.jsx. I added two arrays to hold information about the favorite route stops and the favorite busses. There are getter and setter methods for the favorites page, but they are not functional. The purpose of this page would be to allow the user to select their favorite busses and favorite stops and see them displayed. This page is important to the overall system design because it's one of the pages in the Figma UI diagram. 